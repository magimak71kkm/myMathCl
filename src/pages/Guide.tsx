    ...
    <div className="guide">
      ...
      <div className="card">
        ...
        <ol className="guide-steps">
          ...
          <li><strong>난이도</strong>(하/중/상)와 <strong>문제 개수</strong>(1~10개)를 정합니다.</li>
          <li><strong>문제 생성하기</strong> 버튼을 누르고 10~30초 기다립니다.</li>
        </ol>
      </div>
      ...
      <div className="card">
        ...
        <ul className="guide-steps">
          ...
          <li><strong>인쇄 / PDF 저장</strong> — 브라우저 인쇄 기능으로 문제지를 출력하거나 PDF로 저장합니다. (정답을 숨긴 채 인쇄하면 학생용 문제지가 됩니다)</li>
